!(function () {
  ...
  function normalizeCapLocale(e) {
    const t = String(e || "").toLowerCase();
    return "en" === t || t.startsWith("en-") ? "en" : "zh-CN";
  }
  ...
  class s extends HTMLElement {
    ...
    getI18nText(e, t) {
      const r = this.getAttribute(`data-cap-i18n-${e}`);
      if (r) return r;
      const s = this.getCapLocale();
      return CAP_WIDGET_LOCALES[s]?.[e] || CAP_WIDGET_LOCALES.en[e] || t;
    }
    refreshI18n() {
      if (!this.#i) return;
      const e = this.#i.getAttribute("data-state"),
        t =
          "verifying" === e
            ? ["verifying-label", "Verifying..."]
            : "done" === e
              ...
              : "error" === e
                ...
                : ["initial-state", "Verify you're human"],
        r = this.#i.querySelector("p");
      (r && (r.innerText = this.getI18nText(t[0], t[1])),
        this.#i.setAttribute(
          "aria-label",
    ...
    attributeChangedCallback(e, t, r) {
      ...
      ("data-cap-worker-count" === e && this.setWorkersCount(parseInt(r)),
        ("data-cap-lang" === e || e.startsWith("data-cap-i18n-")) && this.refreshI18n());
    }
